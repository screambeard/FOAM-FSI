...
#       include "setDeltaT.H"
        ...
        movingControlPointsMotion = vector(0.0,0.03,0.0)*(Foam::sin(2*pi*runTime.value())-Foam::sin(2*pi*(runTime.value()-runTime.deltaT().value())));
...
#           include "movingMeshContinuityErrs.H"
        ...
        //Write out norm of ddtPhiCorrector values
        #include "ddtPhiCorrOutput.H"
