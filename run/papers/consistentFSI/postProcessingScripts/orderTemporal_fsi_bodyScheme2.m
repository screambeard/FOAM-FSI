...
% ==== Circle In Circle ==== %
mainDir='/run/papers/consistentFsiRBF/consistent/circleInCircle/U10/paperVersion1_201504/';
...
% movingBodyMesh
% cases={'movingBodyMesh4','movingBodyMesh4','movingBodyMesh4','movingBodyMesh4','movingBodyMesh4'};
% schemes={'bdf1','bdf2_1','bdf2','bdf3_1','bdf3'};
% legendNames={'bdf1','bdf2: (U_{||})_{wall}=1^{st}','bdf2','bdf3: (U_{||})_{wall}=1^{st}','bdf3'};

% FSI Order standard
% cases={'fsiBody3Mesh4_BDF1','fsiBody3Mesh4_RK4-4','fsiBody3Mesh4_BDF2','fsiBody3Mesh4_BDF3'};
% schemes={'bdf1','bdf2','bdf2','bdf3'};
% legendNames={'bdf1','RK4 F(t^{i})','bdf2','bdf3'};
...
% legendNames={'RK4 F(t^{n+1})','RK4 F(t^{n+1/2})','RK4 F(t^{i})','BDF2'};
