...
template<class Type>
scalar bdf2zeroDdtScheme<Type>::deltaT_() const
{
...
template<class Type>
scalar bdf2zeroDdtScheme<Type>::deltaT0_() const
{
...
scalar bdf2zeroDdtScheme<Type>::deltaT0_(const GeoField& vf) const
{
...
template<class Type>
tmp<typename bdf2zeroDdtScheme<Type>::fluxFieldType>
bdf2zeroDdtScheme<Type>::fvcDdtPhiCorr
(
...
template<>
tmp<surfaceScalarField> bdf2zeroDdtScheme<vector>::fvcDdtPhiCorr
(
    const volScalarField& rA,
...
)
{
    ...
    //return zero phi corr -> inconsistent
    ...
    (
        ...
        mesh(),
        dimensioned<scalar>("0", phi.dimensions(), 0.0)
    );
...
template<class Type>
tmp<surfaceScalarField> bdf2zeroDdtScheme<Type>::meshPhi
(
    const GeometricField<Type, fvPatchField, volMesh>& vf
)
{
